...
public class RecruiterMenu {
    ...
    public RecruiterMenu(JobPostingManager jpm, ApplicationManager am) {
        this.jpm = jpm;
        this.am = am;
    }
    ...
    private void createJob() {
        ...
        JobPosting j = (JobPosting) jpm.create(name, desc, hours, payment);
    ...
    private void viewSpecificJob() {
        ...
        int jobNum = readInt();
        JobPosting job = (JobPosting) jpm.findById(jobNum);
        if (job == null) {
